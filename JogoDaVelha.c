...
/*
para entender melhor o c�digo, conhe�a o livro que vai te ensinar linguagem c
de verdade.
link: https://go.hotmart.com/F21553171B?dp=1
*/
...
void voce_joga(char Mat[3][3]) {
 int L,C;
    do {
      ...
      printf("Informe linha e coluna - separe por espaços: (entre 0 e 2): ");
      scanf("%d %d",&L,&C);
